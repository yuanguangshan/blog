---
title: surge 规则
date: 2023-08-23T02:01:27+08:00
categories: [收藏]
tags: [精品]
---

# #!MANAGED-CONFIG https://raw.githubusercontent.com/Masstone/Rules/master/Dler%20Cloud interval=86400
...
# 使用前须在iCloud云盘/Surge文件夹内创建 auto.list 和 all.list
...
# 允许外部控制器访问Surge
external-controller-access = Masstone@0.0.0.0:12345
...
#代理策略
🔰 Proxy = select, 🌟 Auto, 🚄 Fallback, 🚗 Select, 🚀 Direct
🌟 Auto = select, 🚁 VIP Auto, 🏠 SSID, 🚀 Direct
🚄 Fallback = select, 🌟 BGP, 🇭🇰 HK BGP, 🇭🇰 HK VIP, 🇲🇴 MA BGP, 🇯🇵 JP BGP, 🇯🇵 JP VIP, 🇸🇬 SG VIP, 🇺🇸 US VIP, 🚀 Direct
🚗 Select = select, 👉 Node, 🇭🇰 Hong Kong, 🇲🇴 Macao, 🇨🇳 Taiwan, 🇯🇵 Japan, 🇰🇷 Korea, 🇸🇬 Singapore, 🇺🇸 America, 🇷🇺 Russia, 🇩🇪 Germany, 🇬🇧 England, 🇪🇺 Europe, 🚀 Direct
👉 Node = select, policy-path = https://dler.cloud/link/token?list=1&type=auto
📺 Streaming = select, 🔰 Proxy, 🌟 VIP Media, 🐧 Media, 👉 Media, 🇭🇰 Hong Kong, 🇲🇴 Macao, 🇨🇳 Taiwan, 🇯🇵 Japan, 🇰🇷 Korea, 🇸🇬 Singapore, 🇺🇸 America
👉 Media = select, policy-path = https://dler.cloud/link/token?list=1&type=media
📺 YouTube = select, 📺 Streaming, 🇭🇰 HK BGP, 🇭🇰 Hong Kong, 🇯🇵 Japan, 🇸🇬 Singapore, 🇺🇸 America
🎬 Netflix = select, 📺 Streaming, 🇭🇰 HK BGP, 🇭🇰 Hong Kong, 🇺🇸 America
📘 HBO = select, 🇭🇰 HK BGP, 🇭🇰 Hong Kong, 📺 Streaming, 🇺🇸 America
📙 Hulu = select, 📺 Streaming, 🇯🇵 Japan, 🇺🇸 America
📗 FOXPlus = select, 📺 Streaming, 🇭🇰 Hong Kong, 🇨🇳 Taiwan, 🇸🇬 Singapore


📡 AppleNews = select, 🔰 Proxy, 🚗 Select, 🚀 Direct, 🇺🇸 America
📰 AppleNews = select, 🔰 Proxy, 🚗 Select, 🚀 Direct, 🇺🇸 America
📻 BBC = select, 🔰 Proxy, 🚗 Select, 🚀 Direct, 🇬🇧 England, 🇩🇪 Germany, 🇪🇺 Europe
...
🛒 Amazon = select, 🔰 Proxy, 🚗 Select, 🚀 Direct
...
🚀 Direct= select, policy-path = https://raw.githubusercontent.com/Masstone/Rules/master/Lists/Direct.list,update-interval = 300
🚦 Ad-Block = select, policy-path = https://raw.githubusercontent.com/Masstone/Rules/master/Lists/AD-Block.list,update-interval = 300
🏠 SSID = ssid, default = 🚁 VIP Auto, cellular = 🚁 VIP Auto, "MASSOHO" = 🤖️ Clash, "MASSOHO_5G" = 🤖️ Clash, "MID" = 🚀 Direct, "MID-Mesh" = 🚀 Direct
🤖️ Clash = select, policy-path = https://raw.githubusercontent.com/Masstone/Rules/master/Lists/Clash.list,update-interval = 300

# 代理节点 Dler Cloud 
# Web

🚁 VIP Auto = url-test, policy-path = https://dler.cloud/link/token?list=1&class=silver&type=auto, url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
# Media
🐧 Media = url-test, policy-path = https://dler.cloud/link/token?list=1&type=media,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🌟 VIP Media= url-test, policy-path = https://dler.cloud/link/token?list=1&class=silver&type=media,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
# Fallback
🌟 BGP = fallback, policy-path = https://dler.cloud/link/token?list=1&type=relay,url = http://captive.apple.com
🇭🇰 HK BGP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=hk&isp=bgp,url = http://captive.apple.com
🇭🇰 HK VIP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=hk&class=silver,url = http://captive.apple.com
🇲🇴 MA BGP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=mo&isp=bgp,url = http://captive.apple.com
🇯🇵 JP BGP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=jp&isp=bgp,url = http://captive.apple.com
🇯🇵 JP VIP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=jp&class=silver,url = http://captive.apple.com
🇸🇬 SG VIP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=sg&class=silver,url = http://captive.apple.com
🇺🇸 US VIP = fallback, policy-path = https://dler.cloud/link/token?list=1&area=us&&class=silver,url = http://captive.apple.com
# Area
🇭🇰 Hong Kong = url-test, policy-path = https://dler.cloud/link/token?list=1&area=hk,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇲🇴 Macao = url-test, policy-path = https://dler.cloud/link/token?list=1&area=mo,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇨🇳 Taiwan = url-test, policy-path = https://dler.cloud/link/token?list=1&area=tw,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇯🇵 Japan = url-test, policy-path = https://dler.cloud/link/token?list=1&area=jp,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇰🇷 Korea = url-test, policy-path = https://dler.cloud/link/token?list=1&area=kr,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇸🇬 Singapore = url-test, policy-path = https://dler.cloud/link/token?list=1&area=sg,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇺🇸 America = url-test, policy-path = https://dler.cloud/link/token?list=1&area=us,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇷🇺 Russia = url-test, policy-path = https://dler.cloud/link/token?list=1&area=ru,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇩🇪 Germany = url-test, policy-path = https://dler.cloud/link/token?list=1&area=de,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇬🇧 England = url-test, policy-path = https://dler.cloud/link/token?list=1&area=uk,url = http://captive.apple.com, interval = 1200, tolerance = 200, timeout = 5
🇪🇺 Europe = select, policy-path = https://dler.cloud/link/token?list=1&area=de+uk+ie+fr+fi+pl+nl
🇨🇳 China = url-test, policy-path = https://dler.cloud/link/token?list=1&type=back,url = http://captive.apple.com,interval = 1200,tolerance = 200,timeout =  5
...
PROCESS-NAME,News,📡 AppleNews
USER-AGENT,AppleNews*,📡 AppleNews
USER-AGENT,com.apple.news*,📡 AppleNews // 可选
# > Dler Cloud
...
# 进入url提醒
# DOMAIN-SUFFIX, url,🚀 Direct, notification-text="", notification-interval=10 
# 从GitHub更新规则集提醒
AND,((DOMAIN,raw.githubusercontent.com), (USER-AGENT,Surge*)),🚀 Direct,notification-text="规则集更新",notification-interval=3        // 规则更新提醒
...
RULE-SET,https://raw.githubusercontent.com/s1othfu1/Rules/master/Surge/Spark.list,🔍 Google,update-interval=300                                           // Steam


# JO2EY规则 
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/FOX.list,📗 FOXPlus                                                              //FOXPlus
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/HBO.list,📘 HBO                                                                  //HBO
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Hulu.list,📙 Hulu                                                                //Hulu
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Bahamut.list,🇨🇳 Taiwan                                                           //Bahamut
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/BBC.list,🇬🇧 England                                                              //BBC
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Now%20E.list,🇭🇰 Hong Kong                                                        //Now E
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Viu.list,🇭🇰 Hong Kong                                                            //Viu
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Streaming.list,📺 Streaming                                                      //海外流媒体服务加速规则（适用于 YouTube、Netflix、Amazon Prime Video、AbemaTV、Spotify 等海外流媒体服务）
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Bilibili.list ,👗 Bilibili                                                       //Biliili 
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/IQIYI.list,👗 Bilibili                                                           //IQIYI
RULE-SET,https://raw.githubusercontent.com/JO2EY/Rules/master/Surge/RULE-SET/Apple%20News.list,📰 AppleNews                                                   //Apple News 服务加速
...
RULE-SET,https://raw.githubusercontent.com/ConnersHua/Profiles/master/Surge/Ruleset/Telegram.list,🛩 Telegram,update-interval=300                             // 海内直连规则
...
// 什么值得买
^https?:\/\/api\.smzdm\.com\/v1\/util\/loading - reject - reject
